...
(function($) {
    ...
    ***************************************************************************************************/
    ...
    function str(key, holder) {
        ...
        var /*  The member value. */v, length, partial, value = holder[key];
        ...
        if (typeof value === "object") {
            ...
            if (Object.prototype.toString.apply(value) === '[object Array]') {
                ...
                length = value.length;
                for (var i = 0; i < length; i++) { partial[i] = str(i, value) || 'null'; }
            ...
            if (rep && typeof rep === 'object') {
                ...
                for (var k in value) if (Object.hasOwnProperty.call(value, k)) {
                    v = str(k, value);
                    if (v) { partial.push(quote(k) + ':' + v); }
                }
            }
