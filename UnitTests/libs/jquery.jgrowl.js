...
(function($) {
	...
	$.extend( $.fn.jGrowl.prototype , {
		...
		notification: 	function( message , o) {
            ...
            if(o.header != "")
                o.header = '<div class="header">' + o.header + '</div>';
            
            var html = '<div id="'+ o.id +'" class="jGrowl-notification"><div class="close">&times;</div>' + o.header + '<div class="message">' + message + '</div></div>';
			...
			if ( $('div.jGrowl-notification:parent', this.element).size() > 5 && $('div.jGrowl-closer', this.element).size() == 0 && this.defaults.closer != false ) {
